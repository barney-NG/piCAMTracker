...
# News
2019-12-01: [V0.6.3](https://drive.google.com/open?id=14-Zqk-uW1Q9dErGkBKbVC-Mp4glUpEsP) added the possibility to shutdown via GPIO 4 (pin 7) again.
Users of the old image who are using a shutdown button on GPIO 4 (pin 7) need to add _,gpio_pin=4_ to the line _dtoverlay=gpio-shutdown_ in /boot/config.txt
```
